...
import {
  FiltredListProductCategoryComponent
} from './components/filtred-list-product-category/filtred-list-product-category.component';
import {
  FiltredListCategorySubjectComponent
} from './components/filtred-list-category-subject/filtred-list-category-subject.component';
...
import {
  FiltredListProductCategoryComponentModule
} from './components/filtred-list-product-category/filtred-list-product-category.component-module';
...
import {
  FiltredListCategorySubjectComponentModule
} from './components/filtred-list-category-subject/filtred-list-category-subject.component-module';

@NgModule({
  imports: [RouterModule.forRoot([{path: 'crypto', component: CryptoListComponent}, {
    path: 'public-holiday',
